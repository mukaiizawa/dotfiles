...
syn keyword ParenBuiltin symbol-bind
...
syn keyword ParenBuiltin byte-array-new
syn keyword ParenBuiltin []
...
syn keyword ParenBuiltin string-add
syn keyword ParenBuiltin string=
...
syn keyword ParenBuiltin list 
syn keyword ParenBuiltin list-add-last 
syn keyword ParenBuiltin list-length 
syn keyword ParenBuiltin list? 
