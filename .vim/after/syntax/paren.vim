...
syn keyword ParenBuiltin all-adjacent-satisfy?
...
syn keyword ParenBuiltin byte-space?
syn keyword ParenBuiltin byte-alpha?
syn keyword ParenBuiltin byte-digit?
syn keyword ParenBuiltin int->string
syn keyword ParenBuiltin byte-lower
syn keyword ParenBuiltin byte-print?
syn keyword ParenBuiltin byte-upper
syn keyword ParenBuiltin byte->digit
syn keyword ParenBuiltin digit->byte
syn keyword ParenBuiltin =
syn keyword ParenBuiltin &
syn keyword ParenBuiltin \|
syn keyword ParenBuiltin <<
...
syn keyword ParenBuiltin string?
syn keyword ParenBuiltin string->number
